    ...
    <title> Other Metrics </title>
            <style>
                ...
                .circProgressCarbs::before {
                    color: rgb(0,0,256);
                    content: "'''+str(carbs_percentage)+'''% \A Total Carbs: '''+str(total_carbs)+'''g \A Carbs Remaining: '''+str(total_carbs-carbs_counter)+'''g";
                    display: flex;
                    justify-content: center;
                    align-items: center;
                    position: absolute;
                ...
                .circProgressFat::before {
                    color: rgb(0,0,256);
                    content: "'''+str(fat_percentage)+'''% \A Total Fat: '''+str(total_fat)+'''g \A Fat Remaining: '''+str(total_fat-fat_counter)+'''g";
                    display: flex;
                    justify-content: center;
                    align-items: center;
                    position: absolute;
